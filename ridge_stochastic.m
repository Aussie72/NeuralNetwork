...
[theta_0, theta, J_history] = ridge_stochastic_gradient_descent(x, y, theta, alpha, iterations, lambda);
...
%% Ridge Stochastic Gradient Descent Function %%
function [theta_0, theta, J_history] = ridge_stochastic_gradient_descent(x, y, theta, alpha, iterations, lambda)
    m = size(y);
